...
if __name__ == '__main__':
    ...
    elif args.net == 'detnet101': # Not have pretrained model from imanenet.
        FPN = detnet(imdb.classes, 101, pretrained=False, class_agnostic=args.class_agnostic)
    else:
    ...
    if args.resume:
        load_name = os.path.join(output_dir, 'fpn_{}_{}_{}.pth'.format(args.checksession, args.checkepoch, args.checkpoint))
